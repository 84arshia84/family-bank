...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('date_of_loan/{id}', [LoanController::class, 'date_of_loan'])->name('loan.date')->middleware(['permission:loan.date']);
    Route::put('update_status_loan/{id}', [LoanController::class, 'update_status_loan'])->name('loan.update.status ')->middleware(['permission:loan.update.status ']);;
    Route::get('List_of_loans', [LoanController::class, 'List_of_loans'])->name('List.of.loans')->middleware(['permission:List.of.loans']);;

    Route::get('getTransactionDetails/{transactionId}', [TransactionController::class, 'getTransactionDetails'])->name('getTransactionDetails')->middleware(['permission:getTransactionDetails']);;
    Route::get('showUserTransactionId', [TransactionController::class, 'showUserTransactionId'])->name('TransactionId.show.User')->middleware(['permission:TransactionId.show.User']);;

    Route::post('update_status/{id}', [UserController::class, 'update_status'])->name('user.update.status')->middleware(['permission:user.update.status']);;
    Route::get('show_user_details', [UserController::class, 'show_user_details'])->name('user.show.details')->middleware(['permission:user.show.details']);;
    Route::get('all_users', [UserController::class, 'all_users'])->name('user.all')->middleware(['permission:user.all']);;

    Route::post('update_status_Bank_receipt_photo/{id}', [TransactionController::class, 'update_status_Bank_receipt_photo'])->name('update.status.Bank.receipt.photo')->middleware(['permission:update.status.Bank.receipt.photo']);;
    ...
    Route::get('show_transactions_Bank_receipt_photo/{transaction}', [TransactionController::class, 'show_transactions_Bank_receipt_photo'])->name('show.transactions.Bank.receipt.photo')->middleware(['permission:show.transactions.Bank.receipt.photo']);;

    Route::post('Add_money_to_user_account/{user}', [WalletController::class, 'Add_money_to_user_account'])->name('Add.money.to.user.account')->middleware(['permission:Add.money.to.user.account']);;
    ...
    Route::get('all_users_loan_details', [LoanController::class, 'all_users_loan_details'])->name('all.users.loan.details')->middleware(['permission:all.users.loan.details']);;

    Route::get('The_sum_of_users_wallets', [TransactionController::class, 'The_sum_of_users_wallets'])->name('The.sum.of.users.wallets')->middleware(['permission:The.sum.of.users.wallets']);;
    ...
    Route::get('show_all_transaction', [TransactionController::class, 'show_all_transaction'])->name('transaction.show.all')->middleware(['permission:transaction.show.all']);;

    Route::post('wallet/{user}', [WalletController::class, 'wallet'])->name('wallet')->middleware(['permission:wallet']);//find_installment
