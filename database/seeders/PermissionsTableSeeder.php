...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'update.status.Bank.receipt.photo']);
        Permission::create(['name' => 'show.transactions.Bank.receipt.photo']);
        Permission::create(['name' => 'getTransactionDetails']);
        Permission::create(['name' => 'transaction.show.all']);
